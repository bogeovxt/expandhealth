...
use App\Nova\Actions\PhonesExport;
...
class Projector extends Resource
{
    /**
     * The model the resource corresponds to.
     *
     * @var class-string<\App\Models\Projector>
     */
    public static $model = \App\Models\Projector::class;
